...
namespace PizzeriaWebSite.Controllers
{
    public class PayPalController : Controller
    {
        ...
        public ActionResult PaymentWithPaypal()
        {
            ...
            //        Logger.Log("Got " + statusCode.ToString() + " response from server");
        ...
        private Payment CreatePayment(APIContext apiContext, string redirectUrl)
        {
            ...
            PayPal.Api.Item paypalitem = new PayPal.Api.Item();
            //foreach (var x in cart)
            //{
            //    paypalitem = new PayPal.Api.Item();
            //    paypalitem.name = x.product.Product.Name.ToString();
            //    paypalitem.currency = "USD";
            //    paypalitem.price = x.product.Price.ToString();
            //    paypalitem.quantity = x.Quantity.ToString();
            //    paypalitem.sku = "sku";
            ...
            //var cmimi = cart.Sum(i => i.Quantity * i.product.Price);
